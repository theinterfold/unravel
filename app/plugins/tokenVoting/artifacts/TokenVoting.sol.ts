// NOTE: Do not edit. Generated from token-voting-plugin v1.4 npm-artifacts (TokenVotingABI).
export const TokenVotingAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "executed", type: "bool", internalType: "bool" },
      {
        ...
        components: [
          { name: "votingMode", type: "uint8", internalType: "enum MajorityVotingBase.VotingMode" },
          ...
          { name: "snapshotTimepoint", type: "uint64", internalType: "uint64" },
  ...
  },
  {
    ...
    outputs: [{ name: "", type: "uint8", internalType: "enum IMajorityVoting.VoteOption" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_minApprovals", type: "uint256", internalType: "uint256" },
      { name: "_pluginMetadata", type: "bytes", internalType: "bytes" },
      { name: "_excludedAccounts", type: "address[]", internalType: "address[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [{ name: "_timePoint", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    ...
    inputs: [{ name: "_minApprovals", type: "uint256", internalType: "uint256" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    name: "votingMode",
    inputs: [],
    outputs: [{ name: "", type: "uint8", internalType: "enum MajorityVotingBase.VotingMode" }],
    stateMutability: "view",
  },
  {
    type: "event",
  ...
  {
    type: "event",
    name: "ExcludedFromSupply",
    inputs: [{ name: "accounts", type: "address[]", indexed: false, internalType: "address[]" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  },
  {
    type: "event",
    name: "MetadataSet",
    inputs: [{ name: "metadata", type: "bytes", indexed: false, internalType: "bytes" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "voteOption", type: "uint8", indexed: false, internalType: "enum IMajorityVoting.VoteOption" },
  ...
  },
  {
    ...
    inputs: [{ name: "minApprovals", type: "uint256", indexed: false, internalType: "uint256" }],
    anonymous: false,
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "votingMode", type: "uint8", indexed: false, internalType: "enum MajorityVotingBase.VotingMode" },
  ...
  { type: "error", name: "TokenClockMismatch", inputs: [] },
  {
    type: "error",
    ...
    inputs: [
      ...
      { name: "voteOption", type: "uint8", internalType: "enum IMajorityVoting.VoteOption" },
    ],
  },
] as const;
