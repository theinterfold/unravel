// Generated from contracts/out/RosterToken.sol/RosterToken.json
// Regenerate: jq -c .abi contracts/out/RosterToken.sol/RosterToken.json
export const RosterTokenAbi = [
  {
    type: "constructor",
    inputs: [
  ...
  { type: "error", name: "AlreadyHolder", inputs: [{ name: "account", type: "address", internalType: "address" }] },
  ...
  { type: "error", name: "NotHolder", inputs: [{ name: "account", type: "address", internalType: "address" }] },
