...
INTERFOLD_ADDRESS="${INTERFOLD_ADDRESS:-0xDF46f767b95BF018d4E5FF6Be41Fae437E47AC1C}"
CRISP_PROGRAM="${CRISP_PROGRAM_ADDRESS:-0xD980bB00Ee3dfB6da0110CF65529D074c8934f35}"
FEE_TOKEN="${FEE_TOKEN_ADDRESS:-0xA386a424c30F519c7d51Cc809d538AEC3000c17C}"
...
# not silent.
FAUCET="${FAUCET_ADDRESS:-0x1568D441eCC08998ce81A6B3F2655811F9fAb0C3}"
